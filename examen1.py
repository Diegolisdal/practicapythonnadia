...
while opcion == "NUEVO" or opcion == "HORAS" or opcion == "MOSTRAR":
    ...
    if opcion == "NUEVO":
        ...
        lista = [nombre, lider, he, ht, ht*100/he]
        proyectos.append(lista)
        ...
        for proyecto in proyectos:
            if proyecto[0] == modificar:
                proyecto[3] = proyecto[3]+hs
                proyecto[4] = proyecto[2]*100/proyecto[3]
